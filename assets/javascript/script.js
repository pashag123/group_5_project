...
async function fetchDrinks(e) {
    ...
    try {
        ...
        <div id="drink-container" class="container">
            ...
            <p class="drink-text"> <b> Ingredients:</b> ${drinkData.strIngredient1 ? drinkData.strIngredient1 + ', ' : ''
            }${drinkData.strIngredient2 ? drinkData.strIngredient2 + ', ' : ''
            }${drinkData.strIngredient3 ? drinkData.strIngredient3 + ', ' : ''}${drinkData.strIngredient4 ? drinkData.strIngredient4 + ', ' : ''
            }${drinkData.strIngredient5 ? drinkData.strIngredient5 + ', ' : ''}</p>
            <p class="drink-text"> <b> Instructions:</b> ${drinkData.strInstructions
            }</p>
        </div>
        `;
    } catch (error) {
